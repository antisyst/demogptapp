...
var zo = "ERR_INVALID_VALUE";
var Go = "ERR_UNEXPECTED_VALUE";
var Fo = "ERR_UNEXPECTED_TYPE";
var Bn = "ERR_PARSE";
function Pn(t, e) {
  const n = {};
  for (const r in t) {
...
var Re = $("date", (t) => t instanceof Date ? t : new Date(Vt()(t) * 1e3));
function kn(t, e) {
...
var Yo = (t) => {
  const e = Vt(), n = Vt(true), r = j(), o = j(true), s = Jo(true), a = Mt(ie({
...
function Ni(t) {
  ...
  return s.set("tgWebAppPlatform", t.platform), s.set("tgWebAppThemeParams", Xo(t.themeParams)), s.set("tgWebAppVersion", t.version), e && s.set("tgWebAppData", e), n && s.set("tgWebAppStartParam", n), typeof r == "boolean" && s.set("tgWebAppShowSettings", r ? "1" : "0"), typeof o == "boolean" && s.set("tgWebAppBotInline", o ? "1" : "0"), s.toString();
}
function tr(t, e) {
  return $("array", (n) => {
    let r;
...
var nr = "ERR_INVALID_VALUE";
var or = "ERR_UNEXPECTED_VALUE";
var rr = "ERR_UNEXPECTED_TYPE";
var Vn = "ERR_PARSE";
function In(t, e) {
  const n = {};
  for (const r in t) {
...
var sr = O("date", (t) => t instanceof Date ? t : new Date(pt()(t) * 1e3));
function Ln(t, e) {
...
var ar = (t) => {
  const e = pt(), n = pt(true), r = A(), o = A(true), s = It(true), a = T(ce({
    addedToAttachmentMenu: s,
    allowsWriteToPm: s,
    firstName: r,
    id: e,
...
var dr = (t) => {
  const e = A(), n = A(true), r = It(true);
  return Ln({
    botInline: ["tgWebAppBotInline", r],
    initData: ["tgWebAppData", ar(true)],
...
function _r(t) {
  const { initDataRaw: e, startParam: n, showSettings: r, botInline: o } = t, s = new URLSearchParams();
  return s.set("tgWebAppPlatform", t.platform), s.set("tgWebAppThemeParams", jn(t.themeParams)), s.set("tgWebAppVersion", t.version), e && s.set("tgWebAppData", e), n && s.set("tgWebAppStartParam", n), typeof r == "boolean" && s.set("tgWebAppShowSettings", r ? "1" : "0"), typeof o == "boolean" && s.set("tgWebAppBotInline", o ? "1" : "0"), s.toString();
}
var $n = T({
  eventType: A(),
  eventData: (t) => t
...
var gr = (t, e, n) => e in t ? br(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n;
var Hn = (t, e, n) => gr(t, typeof e != "symbol" ? e + "" : e, n);
...
var Pr = "ERR_METHOD_UNSUPPORTED";
var Tr = "ERR_RETRIEVE_LP_FAILED";
var kr = "ERR_METHOD_PARAMETER_UNSUPPORTED";
var Kn = "ERR_UNKNOWN_ENV";
var Or = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var Dr = X("https://web.telegram.org");
function De(t, e) {
...
function fn(t) {
  ...
  return g.withFn(async () => {
    if (qn(window))
      return true;
    try {
      return await xe("web_app_request_theme", "theme_changed", { timeout: 100 }), true;
    } catch {
      return false;
    }
  }, t);
...
var x = (t, e, n) => (n || (n = {}), n.postEvent || (n.postEvent = d), xe(t, e, n));
var d = (t, e) => no()(t, e);
function M(t) {
  return h(() => z(t, L()));
}
var nt = "ERR_POPUP_INVALID_PARAMS";
var Ve = "ERR_INVALID_URL";
var Yr = "ERR_INVALID_SLUG";
var Qr = "ERR_DATA_INVALID_SIZE";
var Kr = "ERR_ACCESS_DENIED";
var jt = "ERR_ALREADY_REQUESTING";
var Ie = "ERR_ALREADY_OPENED";
var Zr = "ERR_ALREADY_MOUNTING";
var Xr = "ERR_VARS_ALREADY_BOUND";
var ts = "ERR_NOT_AVAILABLE";
var es = "ERR_NOT_INITIALIZED";
var mn = "ERR_NOT_SUPPORTED";
var ns = "ERR_NOT_MOUNTED";
function bn() {
...
var Ut = "web_app_setup_back_button";
var ro = "back_button_pressed";
var qt = "backButton";
var ge = u(false);
var lt = u(false);
var os = M(Ut);
...
var ss = Ne("mount", () => {
  lt() || (Le(D() && B(qt) || false), lt.set(true));
});
function Le(t) {
...
function ao(t, e, n, {
  ...
  return (a) => g.withFn(async (i) => {
    ...
    let p;
    try {
      p = [true, await e({ abortSignal: i })];
    } catch (c) {
      p = [false, c];
    }
    zr(() => {
      if (r.set(false), o.set(true), p[0])
        n(p[1]);
      else {
        const c = p[1];
        throw s.set(c), c;
...
var zt = "web_app_biometry_request_auth";
var ds = "web_app_biometry_request_access";
var _s = "web_app_biometry_open_settings";
var fs = "web_app_biometry_update_token";
var $e = "biometry_info_received";
var K = "biometry";
var hs = M(zt);
var ms = U(K);
var bs = P(K, zt);
...
var Jt = "closingBehavior";
var we = u(false);
var dt = u(false);
var lo = Ft(Jt, dt);
var Cs = U(Jt);
var As = lo("disableConfirmation", () => {
  qe(false);
});
var Rs = lo("enableConfirmation", () => {
  qe(true);
});
var Bs = Cs("mount", () => {
  dt() || (qe(
...
var _o = "web_app_invoke_custom_method";
var Yt = P("cloudStorage", _o);
var Ts = M(_o);
var ks = Yt("deleteItem", (t, e) => {
...
var Ds = Yt("getItem", Os);
var xs = Yt("getKeys", (t) => tt("getStorageKeys", {}, t).then(tr(j())()));
var Ms = Yt("setItem", (t, e, n) => tt("saveStorageValue", {
  key: t,
  value: e
}, n).then());
...
var Ct = "web_app_trigger_haptic_feedback";
var He = P("hapticFeedback", Ct);
var Vs = M(Ct);
var Is = He(
  "impactOccurred",
  (t) => {
...
async function bo(t, e, n) {
  ...
  if (e === "url") {
    ...
    r = t, n = e;
  return Pt.set(true), x(ze, "invoice_closed", {
    ...n,
    params: { slug: r },
    capture: (o) => r === o.slug
...
var Zs = E("accentTextColor");
var Ge = E("bgColor");
var Fe = E("buttonColor");
var wo = E("buttonTextColor");
var yo = E("bottomBarBgColor");
var Xs = E("destructiveTextColor");
var ta = E("headerBgColor");
var ea = E("hintColor");
var na = h(() => {
  const { bgColor: t } = q();
  return !t || go(t);
...
var oa = E("linkColor");
var Nt = E("secondaryBgColor");
var ra = E("sectionBgColor");
var sa = E("sectionHeaderTextColor");
var aa = E("sectionSeparatorColor");
var ia = E("subtitleTextColor");
var ca = E("textColor");
function J(t) {
  return h(() => Je()[t]);
}
...
var ft = u(false);
var ua = J("backgroundColor");
var pa = J("hasShineEffect");
var la = J("isEnabled");
var da = J("isLoaderVisible");
var _a = J("isVisible");
var fa = J("text");
var ha = J("textColor");
var ma = "web_app_setup_main_button";
var Eo = "main_button_pressed";
var Qt = "mainButton";
var Ye = U(Qt);
var ba = Ft(Qt, ft);
var ga = Ye("mount", () => {
...
var Ra = Aa(
  ...
  (t) => {
    ...
    return n(), q.sub(n), Tt.set(true), () => {
      e(ke), q.unsub(n), Tt.set(false);
    };
  }
);
var vo = Ca("mount", () => {
...
var ye = "web_app_set_background_color";
var Ee = "web_app_set_bottom_bar_color";
var Ot = "web_app_set_header_color";
var At = "miniApp";
var Xe = {
  any: [
    ye,
...
var xa = ka(
  ...
  () => {
    if (!gt()) {
      const t = D() && B(At);
      vo(), To.ifAvailable(t ? t.backgroundColor : "bg_color"), ko.ifAvailable(t ? t.bottomBarColor : "bottom_bar_bg_color"), Oo.ifAvailable(t ? t.headerColor : "bg_color"), gt.set(true);
    }
  }
);
var Ma = Po("ready", () => {
...
var $a = "web_app_close_scan_qr_popup";
var nn = "web_app_open_scan_qr_popup";
var Ua = "scan_qr_popup_closed";
var qa = "qr_text_received";
var Do = P("qrScanner", nn);
var Se = Do("close", () => {
  Q.set(false), d($a);
});
var Q = u(false);
...
var wt = u(false);
var Ga = H("backgroundColor");
var Fa = H("hasShineEffect");
var Ja = H("isEnabled");
var Ya = H("isLoaderVisible");
var Qa = H("isVisible");
var Ka = H("position");
var Za = H("text");
var Xa = H("textColor");
var Xt = "web_app_setup_secondary_button";
var xo = "secondary_button_pressed";
var te = "secondaryButton";
var rn = P(te, Xt);
var ti = et(te, wt, Xt);
var ei = M(Xt);
var ni = rn("mount", () => {
...
var ee = "web_app_setup_settings_button";
var Mo = "settings_button_pressed";
var ne = "settingsButton";
var ve = u(false);
var yt = u(false);
var ii = M(ee);
var sn = P(ne, ee);
...
var ui = sn("mount", () => {
  yt() || (an(D() && B(ne) || false), yt.set(true));
});
function an(t) {
...
var oe = "web_app_setup_swipe_behavior";
var re = "swipeBehavior";
var Et = u(false);
var fi = M(oe);
var Ce = u(true);
var hi = P(re, oe);
var Io = et(re, Et, oe);
var mi = Io("disableVertical", () => {
  cn(false);
});
var bi = Io("enableVertical", () => {
  cn(true);
});
var gi = hi("mount", () => {
  Et() || (cn(
...
var yi = ae("height");
var Ei = ae("isExpanded");
var Si = h(() => {
  const t = k();
  return t.height === t.stableHeight;
});
var vi = ae("stableHeight");
var Ci = ae("width");
function Ai(t) {
...
var Bi = Ri(
  ...
  (t) => {
    ...
    return n(), k.sub(n), xt.set(true), () => {
      e.forEach(ke), k.unsub(n), xt.set(false);
    };
  }
);
var Pi = jo("expand", () => {
...
function ki() {
  F("viewport_changed", $o), se.set(false);
}
...
var Vi = V(
  ...
  (t) => {
    ...
    return de.set(true), x(Ae, "phone_requested", t).then((e) => e.status).finally(() => {
      de.set(false);
    });
  },
  {
...
var En = "web_app_request_write_access";
var _e = u(false);
var lc = V(
  "requestWriteAccess",
  (t) => {
    ...
    return _e.set(true), x(En, "write_access_requested", t).then((e) => e.status).finally(() => {
      _e.set(false);
    });
  },
  {
...
var Cn = "web_app_switch_inline_query";
var mc = V(
  "switchInlineQuery",
  (t, e) => {
    d(Cn, {
...
function wc() {
  return (0, import_react.useMemo)(G, []);
}
function yc(t) {
  return (0, import_react.useSyncExternalStore)((e) => t.sub(e), t);
}
export {
